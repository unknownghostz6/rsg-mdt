const mdtApp = new Vue({
    ...
    methods: {
        ...
        closeMDT() {
            $.post('http://rsg-mdt/close', JSON.stringify({}));
        },
        getClass(element) {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://rsg-mdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://rsg-mdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://rsg-mdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://rsg-mdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('http://rsg-mdt/submitNewReport', JSON.stringify({
        ...
        SubmitNote() {
            if (this.note_new.title && this.note_new.note) {
                $.post('http://rsg-mdt/submitNote', JSON.stringify({
        ...
        OpenOffenderDetailsById(charidentifier) {
            $.post('http://rsg-mdt/getOffender', JSON.stringify({
        ...
        DeleteSelectedReport() {
            $.post('http://rsg-mdt/deleteReport', JSON.stringify({
        ...
        DeleteSelectedNote() {
            $.post('http://rsg-mdt/deleteNote', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://rsg-mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveNoteEditChanges() {
            $.post('http://rsg-mdt/saveNoteChanges', JSON.stringify({
                id: this.note_selected.id,
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://rsg-mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://rsg-mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://rsg-mdt/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
