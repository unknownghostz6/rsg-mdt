...
Big thanks to Marwen-☭#0001 for helping with conversion
...
1. Make sure to rename to rsg-mdt then ensure rsg_mdt on your resources list. Also disable any other mdt script you are using.
